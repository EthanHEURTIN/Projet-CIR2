...
function displayMN90(reponse){
    ...
    reponse.forEach(element => {
        ajaxRequest('GET', '../request.php/dbMN90Line/?Depth='+element[0] + '&Duration='+element[1], (response) => {
            console.log("Capacity tank : " + response['capacity_tank_l']);
            console.log("Pressure tank : " + response.pressure_tank);
            console.log("Number stages : " + response.nb_paliers);
