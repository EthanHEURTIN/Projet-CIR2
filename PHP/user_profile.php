                ...
                <div>
                  <form>
                    ...
                    <div class="mt-10 flex items-center justify-center gap-x-6 pb-4">
                      <button type="submit" class="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Save my preferences</a>
                    </div>
                  </form>
                </div>
              </div>
