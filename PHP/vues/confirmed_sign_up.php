      ...
      <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
          <div class="px-4 py-5 sm:px-6">
            ...
            <a href="profile.php" class="bg-blue-500 text-white py-8 my-5 rounded-md px-3 text-sm font-medium hover:bg-blue-700 rounded-md text-sm font-medium">Create a new profile</a>  
          </div></div></div></div>
  </body>
